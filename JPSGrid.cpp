//code made by Hugo Villanua Vega
//https://github.com/hvillanua/jps
...
bool Grid::valid_move(const Location& loc, const Location& dir) const {
	...
	//changed by Dimana Radeva
	//by removing this JPS will move to the diagonal when the cell is free,
	//evn if one or both of the adjacent orthogonal cells are blocked, 
	//enables corner-cutting behavior
